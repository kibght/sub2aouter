> 基于上游版本 [Sub2API 0.2.5](https://github.com/Wei-Shaw/sub2api/releases/tag/v0.2.5)（v0.2.5）。
...
Apophis 主题版本 0.1.258，生成自上游提交 `86f93c28ee34cc74b629dafb748bd5ac5ca8c5ea`。
