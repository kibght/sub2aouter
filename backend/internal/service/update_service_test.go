...
func TestCompareVersionsAcrossReleaseSchemes(t *testing.T) {
	tests := []struct {
		current string
		latest  string
		want    int
	}{
		{current: "2026.7.21", latest: "2026.7.22", want: -1},
		{current: "2026.7.99", latest: "2026.8.1", want: -1},
		{current: "2026.12.99", latest: "2027.1.1", want: -1},
		{current: "2026.7.26", latest: "0.1.200", want: -1},
		{current: "0.1.200", latest: "2026.7.26", want: 1},
		{current: "0.1.200", latest: "0.1.201", want: -1},
		{current: "2026.7.26", latest: "0.1.199", want: 1},
	}
...
func TestUpdateServiceDetectsMigrationToSemanticRelease(t *testing.T) {
	client := &updateServiceGitHubClientStub{
		release: &GitHubRelease{
			TagName: "v0.1.200",
			Name:    "Sub2Aouter 0.1.200",
			HTMLURL: "https://github.com/kibght/sub2aouter/releases/tag/v0.1.200",
		},
	}
	svc := NewUpdateService(&updateServiceCacheStub{}, client, "2026.7.26", "docker")
