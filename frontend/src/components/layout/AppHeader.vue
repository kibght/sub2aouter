<template>
  <header class="app-header glass sticky top-0 z-30 border-b border-gray-200/50 dark:border-dark-700/50">
    <div class="app-header-inner flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      <!-- Left: Mobile Menu Toggle + Page Title -->
      <div class="app-header-title-wrap flex shrink-0 items-center gap-2 sm:gap-4">
        <button
        ...
        <div class="hidden lg:block">
          <h1 class="app-header-title text-lg font-semibold text-gray-900 dark:text-white">
            {{ pageTitle }}
          </h1>
          <p v-if="pageDescription" class="app-header-description text-xs text-gray-500 dark:text-dark-400">
            {{ pageDescription }}
          </p>
        </div>
      </div>
      ...
      <div class="app-header-actions flex min-w-0 items-center gap-1 sm:gap-3">
        <!-- Announcement Bell -->
        ...
        <div
          v-if="user"
          class="app-header-balance group relative hidden items-center gap-2 rounded-xl bg-primary-50 px-3 py-1.5 dark:bg-primary-900/20 sm:flex"
        >
          <svg
            class="app-header-balance-icon h-4 w-4 text-primary-600 dark:text-primary-400"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            stroke-width="1.5"
          ...
          <span class="app-header-balance-value text-sm font-semibold text-primary-700 dark:text-primary-300">
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            class="app-header-user flex items-center gap-2 rounded-xl p-1.5 transition-colors hover:bg-gray-100 dark:hover:bg-dark-800"
            :aria-label="t('common.userMenu')"
          >
            <div class="app-header-avatar flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-primary-500 to-primary-600 text-sm font-medium text-white shadow-sm">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
            ...
            <div class="app-header-user-copy hidden text-left md:block">
              <div class="app-header-user-name text-sm font-medium text-gray-900 dark:text-white">
                {{ displayName }}
              </div>
              <div class="app-header-user-role text-xs text-gray-500 dark:text-dark-400">
...
// Console avatar uses the stable numeric user ID.
