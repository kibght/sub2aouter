> 基于上游版本 [Sub2API 0.2.4](https://github.com/Wei-Shaw/sub2api/releases/tag/v0.2.4)（v0.2.4）。
...
Apophis 主题版本 0.1.257，生成自上游提交 `5de5e2bed035d43591a2e10e51f420ef6a84eb98`。
