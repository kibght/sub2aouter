> 基于上游版本 [Sub2API 0.2.3](https://github.com/Wei-Shaw/sub2api/releases/tag/v0.2.3)（v0.2.3）。
...
Apophis 主题版本 0.1.256，生成自上游提交 `8fa67d477d6651a744754392a8982ea589c26ae6`。
